class GameRTDP:
    ...
    def __init__(
        ...
        heuristic: Optional[Callable[[ProbabilisticGameGraph.StateNode], float]] = None,
        max_steps: int = 1000,
    ...
    def trial(
        ...
        extender: Callable[
            [ProbabilisticGameGraph.StateNode, Set[ProbabilisticGameGraph.StateNode]],
    ...
    def greedy_action(
        ...
        explored: Set[ProbabilisticGameGraph.StateNode],
    ) -> Tuple[ProbabilisticGameGraph.ActionNode, float]:
    ...
    def pick_next_state(
        self, action_node: ProbabilisticGameGraph.ActionNode
    ) -> ProbabilisticGameGraph.StateNode:
        population = []
        weights = []
